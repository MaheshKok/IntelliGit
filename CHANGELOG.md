...
- Added **Rebase...** to IntelliGit file menus in Explorer, editor tabs, and the editor. Choose a local or remote branch to rebase the selected file's repository onto, with conflicts kept in that repository's session.
...
- Added **Add to VCS** to IntelliGit file menus in Explorer, editor tabs, and the editor.
- Bring an untracked file into Changes without staging its contents or changing other files.

## [0.35.9] - 2026-09-26

### Added

- Added **Commit File...** to IntelliGit file menus in Explorer, editor tabs, and the editor.
- Enter a message to commit the selected file's saved changes without including other staged files.

## [0.35.8] - 2026-09-20

### Added

- Added **Push** to IntelliGit file menus in Explorer, editor tabs, and the editor.
- Push sends the selected file's repository current branch through IntelliGit's existing safe push, publish, and rebase-retry flow. It never force-pushes.

## [0.35.7] - 2026-09-20

### Added

- Added **Pull** to IntelliGit file menus in Explorer, editor tabs, and the editor.
- Pull updates the selected file's repository with rebase while preserving IntelliGit's dirty-worktree and unpublished-branch safeguards.

## [0.35.6] - 2026-09-20

### Added

- Added **Fetch** to IntelliGit file menus in Explorer, editor tabs, and the editor.
- Fetch updates remote branch information for the selected file's repository without changing local files.
...
- Restored support for VS Code `1.107.0` and later while retaining package-smoke coverage on VS Code `1.137.0`.
...
- Right-click an untracked file in IntelliGit's Changes view and choose **Add to VCS** to start tracking it. When multiple untracked files are selected with **Cmd** or **Ctrl**, the command adds them together.
...
- Amend history now keeps full commit identities, so commits with the same abbreviated hash render as distinct rows.
