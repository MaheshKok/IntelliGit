 ...
 * reuse the guard directly -- `webviewFixtureGate.disposal.test.ts` exercises it through the real
 * `commit-info` entry's `record`, the way every consumer reaches it.
 */
