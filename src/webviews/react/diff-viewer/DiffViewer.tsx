...
import { useRevertHunk, type DiffViewerHost } from "./diffViewerHost";
...
/** Renders the existing diff surface with a host-owned snapshot and actions. */
export function DiffViewer({ host }: { host: DiffViewerHost }): React.ReactElement {
    const { data, error, ignoreMode, handleIgnoreMode, handleEdit } = host;
