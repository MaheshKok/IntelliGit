...
export function WorktreeSmallIcon({
    ...
    return (
        ...
        >
            <path
                fill="currentColor"
                d="M8.85 7.15a.5.5 0 0 0-.7.7L8.29 8H5.75A.75.75 0 0 1 5 7.25v-3.5A.75.75 0 0 1 5.75 3h2.54l-.14.15a.5.5 0 1 0 .7.7l1-1a.5.5 0 0 0 0-.7l-1-1a.5.5 0 1 0-.7.7l.14.15H5.75A1.75 1.75 0 0 0 4 3.75V5H.5a.5.5 0 0 0 0 1H4v1.25A1.75 1.75 0 0 0 5.75 9h2.54l-.14.14a.5.5 0 1 0 .7.71l1-1a.5.5 0 0 0 0-.71l-1-1Z"
            />
        </svg>
    );
}
