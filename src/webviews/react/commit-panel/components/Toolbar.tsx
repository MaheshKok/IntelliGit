...
export function Toolbar({
    ...
    return (
        ...
        >
            ...
            <ToolbarButton label="Rollback" onClick={onRollback} color="#b8adff">
                <path
                    fill="currentColor"
            ...
            <ToolbarButton label="Group by Directory" onClick={onToggleGroupBy} color="#efc09a">
                <path
                    fill="currentColor"
            ...
            <ToolbarButton label="Shelve Changes" onClick={onShelve} color="#ea8fb3">
                <path
                    fill="currentColor"
            ...
            <ToolbarButton label="Show Diff Preview" onClick={onShowDiff} color="#8fd5ff">
                <path
                    fill="currentColor"
            ...
            <ToolbarButton label="Collapse All" onClick={onCollapseAll} color="#f3b1cf">
                <path
                    fill="currentColor"
                    fillRule="evenodd"
